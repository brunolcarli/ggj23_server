...
enemies_spots = {
    ...
    'open_fields_area8': {
        'spider': [(15, 19), (10, 36), (7, 45), (14, 50), (37, 53), (50, 55), (50, 61), (33, 26), (43, 17), (40, 8)],
        'goblin': [(26, 14), (23, 36), (33, 45), (33, 51), (56, 51), (56, 60), (55, 27), (57, 23), (56, 17), (60, 4), (64, 9)],
        'wolf': [(15, 14), (20, 17), (27, 18), (22, 34), (51, 26), (50, 17), (54, 7), (53, 55), (41, 56), (23, 47)]
    },
    'open_fields_area9': {
        'spider': [(11, 17), (12, 13), (9, 29), (4, 41), (8, 52), (17, 52)],
        'goblin': [(17, 6), (32, 12), (62, 13), (61, 28), (52, 39), (59, 47), (62, 52), (54, 43), (48, 39)],
        'wolf': [(27, 23), (30, 29), (21, 37), (21, 44), (34, 45), (37, 53), (42, 47), (39, 37), (40, 29), (45, 21), (50, 30), (39, 21)]
    },
    'open_fields_area10': {
        'spider': [(3, 18), (3, 30), (6, 42), (5, 54), (6, 64), (8, 69), (2, 71), (13, 75), (22, 30), (42, 44)],
        'goblin': [(8, 19), (8, 31), (16, 43), (27, 15), (43, 14), (53, 18), (55, 37), (16, 42), (51, 62), (51, 74)],
        'wolf':  [(5, 26), (11, 42), (18, 61), (21, 70), (26, 61), (37, 62), (43, 68), (31, 29), (39, 25), (44, 27)]
    },
    'open_fields_area11': {
    ...
    'snow_fields_area1': {
        'spirit': [(22, 83), (26, 91), (22, 95), (2, 66), (11, 57), (2, 46), (14, 45), (9, 26), (9, 17), (22, 15), (6, 5), (20, 64)],
        'golem': [(37, 96), (43, 92), (51, 96), (61, 92), (70, 96), (36, 69), (47, 70), (56, 66), (67, 68), (43, 47), (48, 42), (55, 44), (60, 35), (35, 21), (42, 29), (51, 12), (51, 16), (48, 19), (44, 9), (9, 17), (40, 2), (38, 15), (36, 27), (33, 6), (45, 11)],
        'killer_fungus': [(89, 84), (86, 94), (93, 80), (93, 60), (94, 42), (75, 62), (80, 39), (87, 20), (96, 16), (76, 8), (71, 3), (84, 2)]
    },
    'snow_fields_area2': {
        'spirit': [(8, 35), (8, 45), (5, 53), (13, 25), (37, 50), (52, 50), (7, 11), (13, 4), (42, 10), (2, 7), (3, 29), (46, 15)],
        'golem': [(20, 40), (21, 48), (42, 50), (42, 38), (25, 25), (22, 10), (48, 20), (49, 6), (55, 50)],
        'killer_fungus': [(29, 36), (30, 50), (45, 46), (46, 52), (59, 52), (59, 45), (55, 28), (55, 10), (59, 7), (30, 7), (33, 13)]
    },
